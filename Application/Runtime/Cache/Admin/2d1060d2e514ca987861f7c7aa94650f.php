                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" name="class" id="select" onchange="getOption()">
                                        <option>请选择</option>
                                        <?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($i % 2 );++$i;?><option name="class" value="<?php echo ($class["class_id"]); ?>"><?php echo ($class["grade"]); echo ($class["subject"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" name="stu">
                                        <option id="rehe-select-op">请选择</option>
                                    </select>
                                </div>
                            </div>
