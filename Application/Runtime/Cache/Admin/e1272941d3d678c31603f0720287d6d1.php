                                ...
                                <form id="singcms-listorder">
                                    <table class="table table-hover table-striped singcms-table">
                                        ...
                                        <?php if(is_array($comment)): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comment): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a id="rehe-detail"  attr-commentid3="<?php echo ($comment["comment_id"]); ?>">
                                                    点我查看
                                                    </a>
                                                </td>
                                                <td><?php echo ($comment["comment_time"]); ?></td>
                                                <td><span attr-id="<?php echo ($comment["comment_id"]); ?>" class="sing_cursor singcms-on-off" id="comment-on-off">
                                                    <?php echo (getCommentType($comment["status"])); ?>
                                                    </span></td>
                                                <td>
...
<script>
    var SCOPE = {
        'skip_url' : 'admin.php?c=commentExt&a=add',
        'edit_url' :'admin.php?c=commentExt&a=edit',
        'set_status_url' : 'admin.php?c=commentExt&a=setStatus',
        'listorder_url' : 'admin.php?c=commentExt&a=listorder'
    }
</script>
