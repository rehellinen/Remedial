...
<div class="content">
            ...
            <div class="col-lg-6">
                <form class="form-horizontal" id="rehe-form">
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">剩余课时:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" value="<?php echo ($res["remain_hour"]); ?>" name="remain_hour" id="inputPassword3" placeholder="请填写分数">
                        </div>
                    </div>
    ...
    <script>
        var SCOPE = {
            //点击提交后跳转的链接
            'add_url' : 'admin.php?c=time&a=edit',
            //成功后返回的链接
            'success_url' : 'admin.php?c=time'
        }
    </script>
