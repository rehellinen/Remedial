                        ...
                        <form class="form-horizontal" id="rehe-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5" style="margin-top:5px">
                                    <input type="radio" name="method" id="optionsRadiosInline1" value="-1" checked> 上门
                                    <input style="margin-left: 15px" type="radio" name="method" id="optionsRadiosInline2" value="1"> 到店
                                </div>
                            </div>
