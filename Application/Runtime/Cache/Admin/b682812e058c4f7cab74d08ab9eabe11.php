                                ...
                                <form id="singcms-listorder">
                                    <table class="table table-hover table-striped singcms-table">
                                        ...
                                        <?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teacher): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td><span attr-id="<?php echo ($teacher["tea_id"]); ?>" class="sing_cursor singcms-on-off" id="tea-on-off">
                                                    <?php echo (getTeaType($teacher["tea_type"])); ?>
                                                </span></td>
                                                <!--
                                                        <?php if($teacher['tea_type'] == -1): ?>'待审核'
                                                        <elseif condition="$teacher[tea_type] eq 0"> '审核通过'
                                                        <?php else: ?> '审核未通过'<?php endif; ?>
                                                    -->
                                                <td>
