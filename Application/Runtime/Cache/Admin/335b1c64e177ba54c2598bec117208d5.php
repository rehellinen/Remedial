...
<div class="content">
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-hover table-striped singcms-table">
                                ...
                                <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($res["tea_id"]); ?></td>
                                        <td><?php echo ($res["class_name"]); ?></td>
                                        <td><?php echo ($res["remain_hour"]); ?></td>
                                        <td>
                                            <span class="pe-7s-note" id="rehe-edit" attr-id="<?php echo ($res["id"]); ?>" onclick="edit()"></span>
                                        </td>
    ...
    <script>
        var SCOPE = {
            'add_url' : 'admin.php?c=time&edit',
            'edit_url' :'admin.php?c=time&a=edit',
            'listorder_url' : 'admin.php?c=time&a=listorder'
        }
    </script>
