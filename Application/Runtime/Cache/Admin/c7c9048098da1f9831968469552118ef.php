            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="rehe-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" value="<?php echo ($score["class"]); ?>" name="class" id="inputPassword3" placeholder="请填写分数">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">学生名字:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" value="<?php echo ($score["stu"]); ?>" name="stu" id="inputPassword3" placeholder="请填写分数">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" value="<?php echo ($score["score"]); ?>" name="score" id="inputPassword3" placeholder="请填写分数">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" value="<?php echo ($score["score_remark"]); ?>" name="score_remark" id="inputPassword3" placeholder="请填写分数备注">
                        </div>
                    </div>
